...
## Prototype / Heuristic Components

- Speaker identification uses a lightweight heuristic approach rather than a dedicated deep-learning speaker diarization model.
